 ...
 *       &lt;sequence&gt;
 *         &lt;element name="extraFields" type="{http://www.w3.org/2001/XMLSchema}anyType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetExtraFieldsResponse {
    ...
    protected List<Object> extraFields;
    ...
    public List<Object> getExtraFields() {
        if (extraFields == null) {
            extraFields = new ArrayList<Object>();
        }
